                        ...
                        <c:forEach var="c" items="${categories}">
                            <tr>
                                ...
                                <td class="actions">
                                    ...
                                    <a class="btn btn-danger" href="${pageContext.request.contextPath}/admin/categories?action=delete&id=${c.categoryID}" onclick="return confirm('Xoa the loai nay?')">Xoa</a>
                                </td>
                            </tr>
                        </c:forEach>
                        <c:if test="${empty categories}">
                            <tr>
                                <td colspan="3" class="empty-row-lg">Chua co the loai.</td>
                            </tr>
                        </c:if>
                    </tbody>
                </table>
...
=======
<c:set var="pageTitle" value="Danh sách thể loại" />
    <c:set var="activeTab" value="categories" />
                    ...
                    <c:forEach var="c" items="${categories}">
                        <tr>
                            ...
                            <td class="actions">
                                ...
                                <a class="btn btn-danger" href="${pageContext.request.contextPath}/admin/categories?action=delete&id=${c.categoryID}" onclick="return confirm('Xóa thể loại này?')">Xóa</a>
                            </td>
                        </tr>
                    </c:forEach>
                    <c:if test="${empty categories}">
                        <tr>
                            <td colspan="3" class="empty-row-lg">Chưa có thể loại.</td>
                        </tr>
                    </c:if>
                </tbody>
            </table>
