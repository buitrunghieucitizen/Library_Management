...
<c:set var="pageTitle" value="Thêm tệp sách" />
    ...
    <div class="container">
        <div class="card">
            ...
            <form method="post" action="${pageContext.request.contextPath}/admin/bookfiles?action=create">
                ...
                <label>Tên tệp</label><input type="text" name="fileName" required>
                <label>Liên kết tệp</label><input type="text" name="fileUrl" required>
                <label>Loại tệp</label><input type="text" name="fileType">
                <label>Kích thước tệp</label><input type="number" name="fileSize" min="0" value="0">
                <div class="actions">
