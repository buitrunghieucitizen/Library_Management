...
<c:set var="pageTitle" value="Sửa tệp sách" />
    ...
    <div class="container">
        <div class="card">
            ...
            <form method="post" action="${pageContext.request.contextPath}/admin/bookfiles?action=edit">
                ...
                <label>Tên tệp</label><input type="text" name="fileName" value="${bookFile.fileName}" required>
                <label>Liên kết tệp</label><input type="text" name="fileUrl" value="${bookFile.fileUrl}" required>
                <label>Loại tệp</label><input type="text" name="fileType" value="${bookFile.fileType}">
                <label>Kích thước tệp</label><input type="number" name="fileSize" min="0" value="${bookFile.fileSize}">
