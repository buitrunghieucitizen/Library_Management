            ...
            <div class="student-table-wrap">
                <div class="table-scroll">
                    <table>
                        <thead>
                            <tr>
                                <th>STT</th><th>Mã</th><th>Tên sinh viên</th><th>Email</th><th>Số điện thoại</th><th>Hành động</th>
                            </tr>
                        </thead>
                        <tbody>
                ...
                <div class="pagination">
                    <c:if test="${currentPage > 1}">
                        <c:url var="prevUrl" value="/admin/students">
                            <c:param name="action" value="list"/><c:param name="page" value="${currentPage - 1}"/>
                    ...
                    <c:forEach begin="1" end="${totalPages}" var="p">
                        <c:url var="pageUrl" value="/admin/students">
                            <c:param name="action" value="list"/><c:param name="page" value="${p}"/>
                            <c:if test="${not empty param.search}"><c:param name="search" value="${param.search}"/></c:if>
                        </c:url>
