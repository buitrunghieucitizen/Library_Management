        ...
        <main class="content student-content content-wide">
            ...
            <section class="student-kpi-grid">
                <article class="student-kpi-card">
                    ...
                    <p>Tài khoản đang thao tác với checkout hiện tại.</p>
                </article>
                <article class="student-kpi-card">
                    <span>Số đầu sách</span>
                    <strong>${checkoutItemCount}</strong>
                    <p>Tổng số dòng sản phẩm trong đơn.</p>
                </article>
                <article class="student-kpi-card">
                    <span>Tổng số lượng</span>
                    <strong>${checkoutQuantity}</strong>
                    <p>Số cuốn đang chuẩn bị gửi duyệt.</p>
                </article>
                <article class="student-kpi-card">
                    <span>Item lỗi</span>
                    <strong>${checkoutInvalidCount}</strong>
                    <p>Cần xử lý trước khi có thể xác nhận checkout.</p>
                </article>
            </section>
                ...
                <section class="card table-card">
                    <div class="section-header-inline">
                        <div>
                            ...
                            <div class="note">Rà soát từng dòng trước khi gửi duyệt.</div>
                        </div>
                    </div>
                        ...
                        <table>
                            ...
                            <tbody>
                                ...
                                <c:if test="${empty checkoutItems}">
                                    <tr>
                                        <td colspan="6" class="empty">Danh sách cần mua đang trống.</td>
                                    </tr>
                                </c:if>
                            </tbody>
                        </table>
                ...
                <aside class="card table-card checkout-summary">
                    <div class="section-header-inline">
                        <div>
                            ...
                            <div class="note">Khóa cuối trước khi gửi duyệt.</div>
                        </div>
                    </div>
