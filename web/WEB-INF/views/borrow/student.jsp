        ...
        <main class="content student-content content-wide">
            <section class="page-hero">
                <div>
                    ...
                    <h1>Mượn và mua sách</h1>
                    <p>Quản lý bảng giá, danh sách sách có sẵn, giỏ cần mua, lịch sử đơn và các phiếu mượn hiện tại trong một màn hình thống nhất.</p>
                </div>
            ...
            <section class="student-kpi-grid">
                <article class="student-kpi-card">
                    ...
                    <p>Tài khoản đang thao tác trên trung tâm giao dịch.</p>
                </article>
                <article class="student-kpi-card">
                    <span>Sách khả dụng</span>
                    <strong>${bookTotalItems}</strong>
                    <p>Đầu sách khớp với bộ lọc bên dưới.</p>
                </article>
                <article class="student-kpi-card">
                    <span>Danh sách cần mua</span>
                    <strong>${fn:length(buyListItems)}</strong>
                    <p>Tạm tính hiện tại: ${buyListTotal}</p>
                </article>
                <article class="student-kpi-card">
                    <span>Phiếu đang theo dõi</span>
                    <strong>${fn:length(borrows)}</strong>
                    <p>Gồm các phiếu đang mượn, quá hạn hoặc đã trả.</p>
                </article>
            </section>
            ...
            <section class="card table-card">
                <div class="section-header-inline">
                    <div>
                        ...
                        <div class="note">Theo dõi nhanh mức giá và số lượng còn lại trước khi mua.</div>
                    </div>
                </div>
                    ...
                    <table class="compact-table">
                        ...
                        <tbody>
                            ...
                            <c:if test="${empty bookPrices}">
                                <tr>
                                    <td colspan="6" class="empty">Chưa có bảng giá sách.</td>
                                </tr>
                            </c:if>
                        </tbody>
                    </table>
                    ...
                    <table>
                        ...
                        <tbody>
                            ...
                            <c:if test="${empty availableBooks}">
                                <tr>
                                    <td colspan="4" class="empty">Không có sách phù hợp bộ lọc.</td>
                                </tr>
                            </c:if>
                        </tbody>
                    </table>
            ...
            <section class="student-section-grid">
                        ...
                        <table>
                            ...
                            <tbody>
                                ...
                                <c:if test="${empty buyListItems}">
                                    <tr>
                                        <td colspan="7" class="empty">Danh sách cần mua đang trống.</td>
                                    </tr>
                                </c:if>
                            </tbody>
                        </table>
                ...
                <div class="panel-stack">
                    <section class="card table-card">
                        <div class="section-header">
                            <h3 class="mb-0">Danh sách đã mua</h3>
                            ...
                            <table class="compact-table">
                                ...
                                <tbody>
                                    ...
                                    <c:if test="${empty purchasedOrders}">
                                        <tr>
                                            <td colspan="4" class="empty">Bạn chưa có đơn mua đã duyệt.</td>
                                        </tr>
                                    </c:if>
                                </tbody>
                            </table>
                    ...
                    <section class="card table-card">
                        <div class="section-header">
                            <h3 class="mb-0">Sách đang mượn của bạn</h3>
                            <span class="note">Theo dõi trạng thái trả sách theo từng phiếu.</span>
                        </div>
